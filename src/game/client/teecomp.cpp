...
{
	// Team based colors or spectating
	if(!g_Config.m_tc_forced_skins_method || local_team == -1)
	{
		if(for_team == 0)
		{
			skin_name = g_Config.m_tc_forced_skin1;
			return g_Config.m_tc_force_skin_team1;
		}
		skin_name = g_Config.m_tc_forced_skin2;
		return g_Config.m_tc_force_skin_team2;
	}
...
{
	if(!g_Config.m_tc_colored_tees_method || local_team == -1)
	{
		if(for_team == 0)
			return g_Config.m_tc_dm_colors_team1;
		return g_Config.m_tc_dm_colors_team2;
	}
